...
var _default2 = {
  ...
  created: function created() {
    ...
    this.$nextTick(function () {
      ...
      if (xTable && xTable.isSC) {
        _tools.UtilTools.warn('vxe.error.errProp', ['<vxe-table-column ...>', 'columns']);
      }
    });
  ...
  methods: _objectSpread(_objectSpread({}, methods), {}, {
    ...
    handleRowClassName: function handleRowClassName(params) {
      ...
      clss.push(rowClassName ? _ctor.default.isFunction(rowClassName) ? rowClassName(params) : rowClassName : '');
      return clss;
    },
    ...
    loadColumn: function loadColumn(columns) {
      ...
      _ctor.default.eachTree(columns, function (column) {
        if (column.slots) {
          _ctor.default.each(column.slots, function (func, name, colSlots) {
        ...
        case 'query':
          {
            ...
            if (ajaxMethods) {
              ...
              return Promise.resolve((beforeQuery || ajaxMethods).apply(this, applyArgs)).catch(function (e) {
                ...
                if (rest) {
                  if (_tools.UtilTools.isEnableConf(pagerConfig)) {
                    var total = _ctor.default.get(rest, props.total || 'page.total') || 0;
                    tablePage.total = total;
                    _this6.tableData = _ctor.default.get(rest, props.result || props.data || 'result') || []; // 检验当前页码，不能超出当前最大页数
