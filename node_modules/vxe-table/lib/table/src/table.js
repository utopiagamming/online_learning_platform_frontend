...
var _default2 = {
  ...
  created: function created() {
    ...
    if (this.mouseOpts.area && this.checkboxOpts.range) {
      _tools.UtilTools.error('vxe.error.errConflicts', ['mouse-config.area', 'checkbox-config.range']);
    }
    ...
    } else if (!_vXETable.default._keyboard && (this.checkboxOpts.range || this.keyboardConfig || this.mouseConfig)) {
