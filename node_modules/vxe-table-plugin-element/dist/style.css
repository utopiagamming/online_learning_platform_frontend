...
.vxe-table.c--highlight .vxe-tree-cell > .el-cascader .el-input__inner, .vxe-table.cell--highlight .vxe-cell > .el-input-number .el-input-number__decrease,
...
.vxe-table.c--highlight .vxe-tree-cell > .el-input-number .el-input-number__increase, .vxe-table.cell--highlight .vxe-cell > .el-input-number .el-input__inner,
...
.vxe-table.c--highlight .vxe-tree-cell > .el-input-number .el-input__inner, .vxe-table.cell--highlight .vxe-cell > .el-date-editor .el-input__inner,
...
.vxe-table--filter-element-wrapper > .el-slider .el-slider__runway, .vxe-table .vxe-cell > .el-slider .el-slider__runway, .vxe-table .vxe-tree-cell > .el-slider .el-slider__runway {
  margin: 8px 0; }
  .vxe-table--filter-element-wrapper > .el-slider .el-slider__runway .el-slider__button-wrapper, .vxe-table .vxe-cell > .el-slider .el-slider__runway .el-slider__button-wrapper, .vxe-table .vxe-tree-cell > .el-slider .el-slider__runway .el-slider__button-wrapper {
    z-index: auto; }
...
.vxe-form .vxe-form--item-content > .el-color-picker, .vxe-table .vxe-cell > .el-color-picker, .vxe-table .vxe-tree-cell > .el-color-picker {
